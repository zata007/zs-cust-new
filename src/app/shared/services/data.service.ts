...
import {
  ILoginData, IOrderData, IProfileData,
  IReqAddressData, IRequestGetRestaurantData,
  IRequestGetSkuData, IRequestPlaceOrder, IRequestPlaceOrderForEssential, IRequestRegister, IRequestVerifyOtp, IResponsePlaceOrder, IUpdateProfiledata, IUploadImage, IVehicleData
